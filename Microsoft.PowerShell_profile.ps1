...
function Update-Profile {
    try {
        $url = "https://raw.githubusercontent.com/Ramirez97/powershell-profile/main/Microsoft.PowerShell_profile.ps1"
...
oh-my-posh init pwsh --config https://raw.githubusercontent.com/Ramirez97/powershell-profile/main/parrot.omp.json | Invoke-Expression
...
# Remove History
function Remove-History {Remove-Item (GET-PSReadlineOption).HistorySavePath}
...
$($PSStyle.Foreground.Green)Get-GitStash$($PSStyle.Reset) - Retrieves lost/unreachable git stashes (Use temporary branches instead of stashes).

$($PSStyle.Foreground.Green)Remove-History$($PSStyle.Reset) - Deletes history file
